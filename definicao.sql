...
alter table pedidos	add status_pedido varchar(50);
...
-- Inserir 1 registro na tabela funcionario
insert into funcionario (nome, cpf, data_nascimento, endereco, telefone,email,cargo,salario, data_admissao) values 
...
-- Inserir multiplos registro na tabela funcionario
...
-- Inserir 1 registro na tabela clientes
...
-- Inserir multiplos registro na tabela produtos:
...
-- Inserir multiplos registro na tabela info_produtos:
...
-- Inserir multiplos registro na tabela pedidos:

select * from pedidos;

insert into pedidos(id_cliente,id_funcionario,id_produto,quantidade,data_pdido,status_pedido ) values
...
select * from funcionario;
 ...
 -- Atualizar  CPF 444.555.666-77, com o cargo de 'Garçonete' e salário de 2700.

 update funcionario
 set cargo= 'garçonete', salario= 2700
 where cpf= '444.555.666-77';
 
 -- Atualizalção dos pedidos com data menor que '2024-07-06' para status como 'Concluído'
 
 select * from pedidos;
                      
  update pedidos
 set status_pedido= 'concluído'
 where data_pdido <'2024-07-06';        
 
 -- Remover o funcionário de CPF 222.333.444-55
 
 select * from funcionario where cpf = '222.333.444-55';
